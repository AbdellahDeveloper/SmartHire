...
export async function testLLM(
  ...
  try {
    ...
    const { text } = await generateText({
      model,
      prompt:
        "I want you to act as a code generator. Generate a code for me using get-code tool. Answer ONLY with the code.",
      tools: {
        "get-code": tool({
    ...
    return {
      success: true,
      message: `Connected! Response: ${text.substring(0, 20)}...`,
    };
  } catch (error) {
